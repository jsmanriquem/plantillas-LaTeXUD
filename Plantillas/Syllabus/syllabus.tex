...
\begin{tabularx}{\textwidth}{|c|>{\centering\arraybackslash}m{1cm}|>{\centering\arraybackslash}m{1cm}|>{\centering\arraybackslash}X|}
    \hline
    \makecell{TIPO DE ESPACIO ACADÉMICO:} & \makecell{SÍ} & \makecell{NO} & \makecell{NÚMERO DE HORAS:}  \\ \hline
    Obligatorio básico & \obligatoriobasicoA & \obligatoriobasicoB & \multirow{4}{*}{
        \begin{tabularx}{.963\linewidth}{c>{\centering\arraybackslash}X}
            Trabajo directo & \trabajodirectovar \\
            Trabajo mediano & \trabajomedianovar \\
            Trabajo autónomo & \trabajoautonomovar
        \end{tabularx}
    } \\ 
